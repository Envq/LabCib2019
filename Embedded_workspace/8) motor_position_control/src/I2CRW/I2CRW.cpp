 ...
 */
int I2CRW::readReg(int reg_addr, int *reg_data, int cnt) {
 ...
 *  @return     0 success, non-0 unsuccess
 */
int I2CRW::readReg8(int reg_addr, int *reg_data) {
    return I2CRW::readReg(reg_addr,reg_data,1);
}
 ...
 *  @return     0 success, non-0 unsuccess
 */
int I2CRW::writeReg8(int reg_addr, int reg_data) {
    char cmd[2];
    cmd[0] = (char)reg_addr;
    cmd[1] = (char)reg_data;
